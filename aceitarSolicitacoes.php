...
if(isset($_GET['msg'])){
    ...
    switch($msg){
        ...
        <div id="erro" class="alert alert-danger" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Algum dos dados necessários não foi repassado para o arquivo, contate um administrador.</p>
        </div>
        <?php
        break;
        case 2:
        ?>
        <div id="erro" class="alert alert-danger" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Não foi possível mover o arquivo de imagem, contate um administrador</p>
        </div>
        <?php
        break;
        case 3:
        ?>
        <div id="erro" class="alert alert-danger" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Não foi encontrada a imagem da solicitação no servidor, contate um administrador.</p>
        </div>
        <?php
        break;
        case 4:
        ...
        <div id="erro" class="alert alert-success" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Solicitação aceita com sucesso!</p>
        </div>
        <?php
        break;
        case 5:
        ...
        ?>
        <div id="erro" class="alert alert-danger" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Não foi possível achar a solicitação, por favor entre em contato com o administador.</p>
        </div>
        <?php
        break;
        case 9:
        ?>
        <div id="erro" class="alert alert-success" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Solicitação deletada!</p>
        </div>
        <?php
        break;
        case 10:
        ?>
        <div id="erro" class="alert alert-danger" role="alert" style="position: absolute; width: 100%; font-size:13pt">
            <p align="center">Não foi encontrado imagem no diretório de solicitações, mesmo assim o registro foi apagado.</p>
        </div>
        <?php
    }
}
...
<body>
	<div class="container theme-showcase" role="manin">
		<div class="page-header">
			<h1 align="center">Lista de usuários aguardando aprovação</h1>
		</div>
		<div class="row">
			<div class="col-md-12">
				<table class="table">
					...
					<?php while($rows= mysqli_fetch_assoc($result)) { ?>
  					<tr>
  					<td><?php echo $rows['idSolicitacoes']; ?></td>
  					...
  					<td></td>
  					<td>
  					<button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#exampleModal"  data-whatever="<?php echo $rows['idSolicitacoes']; ?>" data-whatevernome="<?php echo $rows['login'];?>" data-whateverpass="<?php echo $rows['senha']; ?>">Cadastrar</button>

  					<button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#exampleModal2" data-whatever="<?php echo $rows['idSolicitacoes']; ?> ">Apagar</button>
  					</td>
  					</tr>
					<?php } ?>
				</tbody>
  	...
  	<div class="modal-dialog" role="document">
  		<div class="modal-content">
  			...
  			<div class="modal-body">
  				<form method="post" action="aceitarSolicitacoesACT.php" enctype="multipart/form-data">
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  	<div class="modal-dialog" role="document">
  		<div class="modal-content">
  			...
  			<div class="modal-body">
  				<form method="post" action="apagarSolicitacaoACT.php" enctype="multipart/form-data">
  						<label for="recipient-name" class="control-label">Id da solicitação: </label>
  						<input type="text" name="idSoli" class="form-control" id="idSoli" readonly="true">
  				<div class="modal-footer">
...
<script type="text/javascript">
  ...
  var modal = $(this)  
  modal.find('.modal-title').text('Aceitar Cadastro: ' + recipient)
